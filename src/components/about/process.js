  ...
  return (
    <Grid container justify="center">
      <Grid item xs={6} style={{marginTop: 30}}>
        ...
        <Typography variant="body1" color="textPrimary" component="p" align="left" paragraph>
          Do wish to join our network of citizen lawmakers? Register on our platform and start getting experience writing signature ready legislation for your fellow citizens! Let’s discover true democracy.
        </Typography>
      </Grid>
    </Grid>
  )
