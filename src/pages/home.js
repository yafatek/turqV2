        ...
        <Grid container>
          <Grid item>
            <Hero
              ...
              subtext="More calls and emails don’t solve anything. What lawmakers need is to be given a ready made piece of legislation. At turq.io we make that happen. We connect you with people that will solve your issue and turn the solution into legislation. Think Upwork, but for legislation. We then help you get that legislation submitted. Your problems are solved and lawmakers lives are made simpler."
            />
          </Grid>
          <Grid item xs={12}>
            {currentContests
